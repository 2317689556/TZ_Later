    ...
    <div class="content">
        <ul class="vertical-nav dark red" style="text-align: center;">
            ...
            <li><a href="#"><i class="icon-group"></i>账号管理<span class="submenu-icon"></span></a>
                <ul>
                    <c:if test="${USER.gradeId==1}">
                    <li><a href="/user/userFandAll">用户管理</a></li>
                    </c:if>
                    <li><a href="#">修改密码</a></li>
                </ul>
            </li>
            <li><a href="/jsps/vender/venderList.jsp"><i class="icon-question" style="padding-left: 20px;width: 20px;padding-right: 35px;"></i>厂家、代理管理</a>
            </li>
